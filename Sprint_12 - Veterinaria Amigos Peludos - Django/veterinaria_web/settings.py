"""
Django settings for veterinaria_web project.
...
LOGGING = {
    'version': 1,
    'disable_existing_loggers': False,  # mantiene loggers predeterminados
    'formatters': {
        'verbose': {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'veterinaria.log'),
            'formatter': 'verbose',
        },
        'console': {  # opcional: imprime también en consola
